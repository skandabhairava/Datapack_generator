...
from src.commandblock_py.utils.recipes import *
...
mypack.register_function(name="uninstall",content=scoreboard.remove_all(), namespace='pp')
abc = mypack.register_recipe(name="bornn",content=furnace(items_list.WOODEN_HOE, items_list.DIAMOND))
print(abc)
